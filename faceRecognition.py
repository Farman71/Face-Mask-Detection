...
def faceDetection(test_img):
    ...
    # Give path to haar classifier as i have given
    face_haar = cv2.CascadeClassifier(r'F:\project\Face mask detection\Face-Recognition-master\haarcascade_frontalface_alt.xml')
    faces = face_haar.detectMultiScale(
        gray_img, scaleFactor=1.2, minNeighbors=3)
